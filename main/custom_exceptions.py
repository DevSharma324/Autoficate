...
class HeaderDataNotFoundError(
    MainProjectError
):  # TODO: load a page with GET in exception_handler
...
class ImageMediaStorageError(MainProjectError):
    """Error in Image Media Storage Service"""
